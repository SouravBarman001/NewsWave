...
class BannerDetails extends ConsumerStatefulWidget {
  const BannerDetails({super.key, required  this.articleList, required this.index});

  final Article articleList;
  final int index;

  @override
  ConsumerState<BannerDetails> createState() => _NewsDetailsState();
}

class _NewsDetailsState extends ConsumerState<BannerDetails> {
